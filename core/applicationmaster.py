...
class ApplicationMaster(object):
    """
    The Application Master REST API's can be used to get status on the running Application Master including the jobs
    being run by the Application Master and the job particulars like tasks, counters, configuration and attempts.

    """
    def __init__(self, host=None, port=19888, user=None):
        """
        Default Constructor for Application Master Class
        Args:
            host:
            port:
            user:
        ...
        if host:
            ...
            raise MissingParameterException("Application Master Host Address")
    ...
    def applicationmaster_info(self):
        """
        Function used to return the overall information about the Application Master
        Returns:
            Application Master Information in JSON format
        """
    ...
    def mapreduce_jobs(self, user=None, state=None, queue=None, limit=None,
        ...
        """
        Function that returns list of map reduce jobs completed.
        Args:
    ...
    def mapreduce_job(self, job_id=None):
        """
        Function used to return details about job identified by the job id
        Args:
        ...
        """
        if job_id:
            path = "/ws/v1/mapreduce/jobs/{0}".format(job_id)
            resp = self.request(self.url + path)
            return self.response_to_json(resp)
        else:
    ...
    def mapreduce_job_attempts(self, job_id=None):
        ...
        """
        if job_id:
            path = "/ws/v1/mapreduce/jobs/{0}/jobattempts".format(job_id)
            resp = self.request(self.url + path)
            return self.response_to_json(resp)
        else:
    ...
    def mapreduce_job_counters(self, job_id=None):
        """
        Function used to return details about collection of resources that represent the job counters for the JOB ID
        Args:
            job_id: Job ID of particular job
        ...
        """
        if job_id:
            path = "/ws/v1/mapreduce/jobs/{0}/counters".format(job_id)
            resp = self.request(self.url + path)
            return self.response_to_json(resp)
        else:
            raise MissingParameterException("Job ID")
    ...
    def mapreduce_job_conf(self, job_id=None):
        ...
        """
        if job_id:
            path = "/ws/v1/mapreduce/jobs/{0}/conf".format(job_id)
            resp = self.request(self.url + path)
            return self.response_to_json(resp)
        else:
            raise MissingParameterException("Job ID")
    ...
    def mapreduce_job_tasks(self, job_id=None):
        ...
        """
        if job_id:
            path = "/ws/v1/mapreduce/jobs/{0}/tasks".format(job_id)
            resp = self.request(self.url + path)
            return self.response_to_json(resp)
        else:
            raise MissingParameterException("Job ID")
    ...
    def mapreduce_job_task(self, job_id=None, task_id=None):
        ...
        if job_id:
            if task_id:
                path = "/ws/v1/mapreduce/jobs/{0}/tasks/{1}".format(job_id, task_id)
                resp = self.request(self.url + path)
                return self.response_to_json(resp)
            else:
    ...
    def mapreduce_job_task_counters(self, job_id=None, task_id=None):
        ...
        if job_id:
            if task_id:
                path = "/ws/v1/mapreduce/jobs/{0}/tasks/{1}/counters".format(job_id, task_id)
                resp = self.request(self.url + path)
                return self.response_to_json(resp)
            else:
                raise MissingParameterException("Task ID")
    ...
    def mapreduce_job_task_attempts(self, job_id=None, task_id=None):
        ...
        if job_id:
            if task_id:
                path = "/ws/v1/mapreduce/jobs/{0}/tasks/{1}/attempts".format(job_id, task_id)
                resp = self.request(self.url + path)
                return self.response_to_json(resp)
            else:
                raise MissingParameterException("Task ID")
    ...
    def mapreduce_job_task_attempt(self, job_id=None, task_id=None, attempt_id=None):
        ...
        if job_id:
            if task_id:
                if attempt_id:
                    path = "/ws/v1/mapreduce/jobs/{0}/tasks/{1}/attempts/{2}".format(job_id, task_id, attempt_id)
                    resp = self.request(self.url + path)
                    return self.response_to_json(resp)
                else:
    ...
    def mapreduce_job_task_attempt_counters(self, job_id=None, task_id=None, attempt_id=None):
        ...
        if job_id:
            if task_id:
                if attempt_id:
                    path = "/ws/v1/mapreduce/jobs/{0}/tasks/{1}/attempts/{2}/counters".format(job_id, task_id, attempt_id)
                    resp = self.request(self.url + path)
                    return self.response_to_json(resp)
                else:
                    raise MissingParameterException("Attempt ID")
